...
const PARTICIPANT_MERGE_SYNONYMS = [
  { mergeKey: 'organisation_name', patterns: [/^organisation$/i, /^organisation_name$/i] },
  { mergeKey: 'abn', patterns: [/^abn$/i] },
  { mergeKey: 'organisation_email', patterns: [/^organisation_email$/i] },
  { mergeKey: 'organisation_phone', patterns: [/^organisation_phone$/i] },
  { mergeKey: 'organisation_address', patterns: [/^organisation_address$/i] },
  { mergeKey: 'organisation_contact_name', patterns: [/^organisation_contact_name$/i] },

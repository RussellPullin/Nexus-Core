/**
 * Normalize NDIS plan fund-release schedules (quarterly / lumpy instalments).
 * Used when persisting plans and for validation.
 */
 ...
 * @param {string|null|undefined} planStart YYYY-MM-DD
 * @param {string|null|undefined} planEnd YYYY-MM-DD
 * @returns {{ releases: Array<{ date: string|null, proportion: number, label: string, derived_date: boolean, amount_nominal: number|null }>, derived: boolean, warnings: string[], meta: object|null }}
 */
...
/**
 * @param {unknown} input object or JSON string
 * @param {string} planStart
 * @param {string} planEnd
 * @returns {string|null} JSON for DB or null
 */
export function prepareFundReleaseScheduleForStorage(input, planStart, planEnd) {
...
/** @param {unknown} value */
export function parseFundReleaseScheduleFromDb(value) {
...
/**
 * @param {number} annual
 * @param {Array<{ proportion: number }>} releases
 */

...
export const PARTICIPANT_INTAKE_FIELD_DEFS = [
  ...
  // Representative / advocate (distinct from general primary/emergency contact)
  { key: 'representative_first_name', label: 'Representative first name', section: 'representative', type: 'text' },
  { key: 'representative_last_name', label: 'Representative last name', section: 'representative', type: 'text' },
  { key: 'representative_full_name', label: 'Representative full name', section: 'representative', type: 'text' },
  { key: 'representative_relationship', label: 'Representative relationship', section: 'representative', type: 'text' },
  { key: 'representative_phone', label: 'Representative phone', section: 'representative', type: 'text' },
  { key: 'representative_email', label: 'Representative email', section: 'representative', type: 'text' },
...
export const STAFF_ONBOARDING_FIELD_DEFS = [
  ...
  { key: 'street_address', label: 'Street address', step: 1, section: 'personal', type: 'text' },
  { key: 'suburb_city', label: 'Suburb / city', step: 1, section: 'personal', type: 'text' },
  { key: 'state', label: 'State', step: 1, section: 'personal', type: 'text' },
  { key: 'postcode', label: 'Postcode', step: 1, section: 'personal', type: 'text' },
  ...
  { key: 'pay_frequency', label: 'Pay frequency', step: 2, section: 'employment', type: 'text' },
  { key: 'governing_state', label: 'Governing state', step: 2, section: 'employment', type: 'text' },
  { key: 'supervisor_name', label: 'Supervisor / manager name', step: 2, section: 'employment', type: 'text' },
  { key: 'acceptance_deadline_date', label: 'Acceptance deadline date', step: 2, section: 'employment', type: 'date' },
